...
import FriendContextMenu from "@/components/ui/friend-context-menu";
...
export default function ChatMessage({
  ...
  return (
    <>
      <div
        className="flex items-center px-2 py-3 rounded hover:bg-[#35373c] cursor-pointer group"
        onContextMenu={handleContextMenu}
      >
        <div className="relative mr-3">
          <Image
            src={avatar || "/assets/discord_blue.png"}
            alt={name}
            width={40}
            height={40}
        ...
        <div className="flex space-x-2">
          {isActive === "모두" ? (
            <button
              className="w-9 h-9 rounded-full bg-[#2b2d31] flex items-center justify-center"
              onClick={clickHandle}
            >
